...
import javax.swing.*;
public class Company001 extends JFrame implements ActionListener
{
   JFrame jf;	
   JPanel pp;
   JPanel cp1;
   ...
   Company001()
   {
	  ...
	  JButton b3= new JButton("HR");
	  JButton b4= new JButton("Testing");
	  JButton b5= new JButton("Dev_Team");
	  ...
	  //creating 
      JButton b6= new JButton("TCS");
	  JButton b7= new JButton("Wipro");
	  JButton b8= new JButton("Juspay");
	  JButton b9= new JButton("Benchmark");
